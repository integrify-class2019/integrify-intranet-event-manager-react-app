  ...
  handleEnroll = e => {
    ...
    switch (e.target.className) {
      case 'btn-enroll btn-in':
        const outBtn =
          e.target.parentElement.querySelector('.btn-out-active') || e.target.parentElement.querySelector('.btn-out');
      ...
      case 'btn-enroll btn-out':
        const inBtn =
          e.target.parentElement.querySelector('.btn-in-active') || e.target.parentElement.querySelector('.btn-in');
